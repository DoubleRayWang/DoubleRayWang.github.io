...
　　本文转自 [阮一峰的网络日志](http://www.ruanyifeng.com/blog/) 的 [Javascript 严格模式详解](http://www.ruanyifeng.com/blog/2013/01/javascript_strict_mode.html) ，参考文档[Strict mode](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Strict_mode#Changes_in_strict_mode)。<!-- more -->

...
　　于是一系列搜索之后终于找到了两篇根据 [Liquid for Designers](https://github.com/shopify/liquid/wiki/liquid-for-designers) 翻译的不错的文档可以做基本的参考，分别是 [Coffee coder 的 liquid用法笔记](http://blog.csdn.net/dont27/article/details/38097581) 和 [Havee's Space 的 Jekyll 扩展的 Liquid 设计 ](https://havee.me/internet/2013-11/jekyll-liquid-designers.html)。<!-- more -->
